    ...
    if choice=='1':
        ...
        if choice3=='a':
            ...
            if choice4=='a':
                ...
                new_Detail=int(input('What you want it to be:'))
                ...
                new_Detail=int(input('What you want it to be:'))
                products.loc[products['Product_Name'] == NameUpdate,'Inventory']= new_Detail
                print()
                print('Updated')
                print()
                print(products)
        ...
        if choice6=='a':
            ...
            minInventory=int(input('Enter Minimum Inventory limit at which you want alert:'))
            ...
            if choice7=='a':
                ...
                new_Detail1=int(input('What you want it to be:'))
